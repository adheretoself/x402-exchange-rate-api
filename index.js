...
// x402支付配置：用Coinbase免费facilitator，每调用收0.02 USDC on Base
app.use(paymentMiddleware({
  facilitatorUrl: 'https://facilitator.cdp.coinbase.com',
  payTo: '0xa43d27e736EB8c9816102a4C48bB5e8a7Da8c5ef',  // 重要！替换成你的0x地址
  amount: '0.02',  // 每调用0.02 USDC（可改成0.01吸引更多流量）
  asset: 'USDC',
  chainId: 'base:8453'  // Base主网
}));

// 添加Bazaar发现（让AI代理自动找到你的服务）
